...
namespace Allup_DataAccess.Migrations
{
    ...
    [Migration("20250824100619_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Allup_Core.Entities.About", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Allup_Core.Entities.AppUserChat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Allup_Core.Entities.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Allup_Core.Entities.Compare", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Allup_Core.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Allup_Core.Entities.AppUserChat", b =>
                {
                    ...
                    b.HasOne("Allup_Core.Entities.Chat", "Chat")
            ...
            modelBuilder.Entity("Allup_Core.Entities.Message", b =>
                {
                    b.HasOne("Allup_Core.Entities.Chat", "Chats")
                        .WithMany("Messages")
                        .HasForeignKey("ChatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Allup_Core.Entities.AppUser", "Sender")
                        .WithMany()
